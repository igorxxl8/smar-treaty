...
namespace SmarTreaty.Controllers
{
    ...
    public class ContractsController : DefaultController
    {
        ...
        {
            var res = await _smartContractService.CompileContract(@"pragma solidity >=0.4.22 <0.6.0;contract test_xtemplate {int _multiplier;constructor() public {}function test_(int multiplier) public {_multiplier = multiplier;}function multiply(int val) public returns(int result) {result = val * _multiplier;}}");
